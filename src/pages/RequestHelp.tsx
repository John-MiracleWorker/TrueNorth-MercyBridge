          ...
          {step === 1 && (
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-2" role="radiogroup" aria-labelledby="category-label">
                  {CATEGORIES.map((cat) => (
                    <button
                      key={cat.value}
                      type="button"
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-2" role="radiogroup" aria-labelledby="urgency-label">
