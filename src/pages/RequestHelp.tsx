          ...
          {step === 1 && (
            <div className="space-y-6">
              ...
              <div>
                ...
                <div role="radiogroup" aria-labelledby="category-group-label" className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-2">
                  {CATEGORIES.map((cat) => (
                    <button
                      key={cat.value}
                      type="button"
              ...
              <div>
                ...
                <div role="radiogroup" aria-labelledby="urgency-group-label" className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-2">
                  {URGENCY_LEVELS.map((level) => (
                    <button
                      ...
                      className={`p-4 rounded-xl border text-left text-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900 ${formData.urgency_level === level.value ? 'border-amber-500 bg-amber-500/10 text-white' : 'border-white/10 text-slate-300 hover:border-slate-600'}`}
                    >
